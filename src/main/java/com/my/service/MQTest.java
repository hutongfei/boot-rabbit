...
//        rabbitTemplate.setConfirmCallback(this);// 开启confirm 模式
...
//    }
//
//    @RabbitListener(queues = {RabbitMqConfig.SIMPLE_ONE,RabbitMqConfig.TOPIC_QUEUE_ONE,RabbitMqConfig.TOPIC_QUEUE_TWO})
